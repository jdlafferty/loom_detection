...
The synthetic data used in this paper can account for many possible stimuli that a fly may encounter. However, natural stimuli has been suggested to be very important to shape the properties of the circuit in retina \citep{tanaka2019deep}. Thus, adding more complicated structures in the stimuli is a reasonable next step. For example, a natural environment usually has a very complex background, including foliage, trees, clouds and other natural visual structures. Objects that are moving in the visual field may also be present, some of approaching. Moreover, looming signals could be corrupted by various sources of noise, including unstable illuminations, occlusions, and intrinsic neural stochasticity. An interesting follow-on study will be to investigate the effects more complex and naturalistic stimuli may have on the trained filters and performance of the ensemble of units.
